...
class EglBase14 extends EglBase {
    ...
    public static boolean isEGL14Supported() {
        Log.d("EglBase14", "SDK version: " + CURRENT_SDK_VERSION + ". isEGL14Supported: " + (CURRENT_SDK_VERSION >= 18));
    ...
    public static class Context implements EglBase.Context {
        ...
        public long getNativeEglContext() {
            return EglBase14.CURRENT_SDK_VERSION >= 21 ? this.egl14Context.getNativeHandle() : (long) this.egl14Context.getHandle();
        }
